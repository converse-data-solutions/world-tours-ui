...
const LoginForm: React.FC<ChildProps> = ({onChildClick}) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full">
                  ...
                  <div className="lg:w-[50%] px-[15px]">
                    <h3 className="mb-4 pb-4 text-center Play-fair text-[22px] font-semibold">Login</h3>
                    <div className="flex justify-between">
                      ...
                      <button className="text-[14px] bg-[#DD4B39] rounded-xl text-white model-btn">
                        <span><GoogleIcon style={{fontSize:"20"}} className="mr-2"/></span>
                    ...
                    <h3 className="text-center text-[#777777] text-[16px]">
                      Don't have an account? <span className="text-[#029e9d]" onClick={()=>{loginModel("reg")}}>Register</span>
                    </h3>
                  </div>
                </div>
  )
